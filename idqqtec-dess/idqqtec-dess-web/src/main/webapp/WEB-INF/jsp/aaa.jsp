...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-12 column" id="topDiv">
            <div align="center">
            ...
            <ul class="nav nav-pills">
                ...
                <%--<li>--%>
                <%--<a href="#" onclick="showEquipment()">设备</a>--%>
                <%--</li>--%>
                <%--<li>--%>
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-6 column">
            <div id="ssdPie" style="height: 70%"></div>
            <div id="mysqlMonitor" style="height: 70%"></div>
            <div id="equipment" style="height: 70%">
                <h4>
...
<script>
    ...
    function showEquipment() {
        ...
        // $("#equipment").html("<h4>This is Equipment HTML</h4>")
    }
</script>
</body>
</html>
